    ...
    <div style="width: 1000px;margin-left: 200px" id="add_div" class="row">
        <div class="col-md-8 col-md-offset-4">
            <div class="row" id="row_div">
                ...
                <div class="col-md-9">
	                <input class="easyui-combobox" name="userId" editable="false"
						data-options="
                ...
                <div class="col-md-9">
                	<input class="easyui-combobox" name="costId" editable="false"
						data-options="
                ...
                <div class="col-md-9">
	                <input class="easyui-combobox" name="serverId" editable="false"
							data-options="
