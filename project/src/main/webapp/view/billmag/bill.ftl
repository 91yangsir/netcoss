	...
	<div style="margin-left: 350px; margin-top: 20px;">
		<div class="easyui-panel" title="角色管理" style="width: 600px;">
			<form id="ff" method="post">
				<br> 用户姓名: <input class="easyui-textbox" type="text"
					id="userName" name="userName"> <br> <br> 身份证号: <input
					class="easyui-textbox" type="text" id="idCard" name="idCard">
				<br>
				<br> 账务账号: <input class="easyui-textbox" type="text"
					id="userAcc" name="userAcc"> <br>
				<br> 年份: <input class="easyui-textbox" type="text" id="useYear"
					name="useYear"> <br>
				<br> 月份: <input class="easyui-textbox" type="text"
